import { NotionTodoRepository, Todo, Todos } from '../src/notionswiftbar.60s';
...
beforeEach(() => {
	...
	notionTodoRepositorySpy = jest
		.spyOn(NotionTodoRepository.prototype, 'fetchTodos')
		.mockImplementation(() => [todoOne, todoTwo, todoThree]);
});
